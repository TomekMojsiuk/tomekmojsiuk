...
"use strict";
eval("\n\n$(function () {\n\n  //Create hamburger \n  var nav = $(\"nav\");\n  console.log(nav);\n\n  var hamburger = $(\"<div class='hamburger'>\" + \"<div class='hamburger--line'></div>\" + \"<div class='hamburger--line'></div>\" + \"<div class='hamburger--line'></div>\" + \"</div>\");\n\n  nav.prepend(hamburger);\n\n  //Toggle mobile-nav on click\n\n  if (window.matchMedia(\"(max-width: 640px)\").matches) {\n    var mainNavList = $('.main--nav--list');\n    mainNavList.hide();\n    hamburger.on('click', function () {\n      mainNavList.toggle();\n    });\n  }\n});\n\n//# sourceURL=webpack:///./js/hamburger.js?");
