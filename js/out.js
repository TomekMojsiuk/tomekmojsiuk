...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar portfolio = function portfolio() {\n  //Projects\n  var invoiceMe = $(\".invoice__me\").find(\".icon\");\n  var invoiceMeCodePreview = \"https://github.com/TomekMojsiuk/invoice-generator\";\n  var invoiceMeLivePreview = \"https://invoice-me.netlify.com/\";\n\n  var weatherApp = $(\".weather__app\").find(\".icon\");\n  var weatherAppCodePreview = \"https://github.com/TomekMojsiuk/weather-app\";\n  var weatherLivePreview = \"https://tm-weather.netlify.com/\";\n\n  var projectPreview = function projectPreview(projectName, codePreviewUrl, livePrevievUrl) {\n    projectName.each(function (index) {\n      $(this).on(\"click\", function () {\n        if (index === 0) {\n          window.open(codePreviewUrl);\n        } else {\n          window.open(livePrevievUrl);\n        }\n      });\n    });\n  };\n\n  new projectPreview(invoiceMe, invoiceMeCodePreview, invoiceMeLivePreview);\n  new projectPreview(weatherApp, weatherAppCodePreview, weatherLivePreview);\n};\n\nexports.default = portfolio;\n\n//# sourceURL=webpack:///./js/portfolio.js?");
